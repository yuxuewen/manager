...
//        LOGGER.info("{}", JSONUtil.parse(webLog));
        Object result = joinPoint.proceed();
        WebLog webLog=setWebLog(joinPoint,result,0);
        logService.createLog(webLog);
        return result;
}

    @AfterThrowing(pointcut ="webLog()",throwing = "e")
    public void handleThrowing(JoinPoint joinPoint, Exception e){
        WebLog webLog=setWebLog(joinPoint,e.toString(),1);
        logService.createLog(webLog);
        LOGGER.info("{}", "抛出异常");
    ...
    private WebLog setWebLog(JoinPoint joinPoint,Object result,int type){
